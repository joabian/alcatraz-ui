...
function notifyCtrl($scope, notify) {
    ...
    $scope.inspiniaDemo1 = function(){
        notify({ message: 'Info - This is a SAGA info notification', classes: 'alert-info', templateUrl: $scope.inspiniaTemplate});
    }
    $scope.inspiniaDemo2 = function(){
        notify({ message: 'Success - This is a SAGA success notification', classes: 'alert-success', templateUrl: $scope.inspiniaTemplate });
    }
    $scope.inspiniaDemo3 = function(){
        notify({ message: 'Warning - This is a SAGA warning notification', classes: 'alert-warning', templateUrl: $scope.inspiniaTemplate });
    }
    $scope.inspiniaDemo4 = function(){
        notify({ message: 'Danger - This is a SAGA danger notification', classes: 'alert-danger', templateUrl: $scope.inspiniaTemplate });
    }
}
...
function toastrCtrl($scope, toaster){
    ...
    $scope.demo1 = function(){
        toaster.success({ body: "Hi, welcome to SAGA. This is example of Toastr notification box." });
    };
...
function datatablesCtrl($scope,DTOptionsBuilder,$http){
    ...
    $scope.dtOptions = DTOptionsBuilder.newOptions()
     ...
     $http.get('Service1.asmx/GetAllEmployees2')
        .then(function (response) {
...
/* nuevo controlador */
function datatablesCtl($scope,DTOptionsBuilder,$http){
...
angular
    ...
    .controller('datatablesCtl', datatablesCtl)
